...
select 
      ...
      ,countif(pet_current_age_months<=5 and species='dog') as active_puppy_policies_dog_only
      ,countif(pet_current_age_months>=6 and pet_current_age_months<=24 and species='dog') as active_adolescent_policies_dog_only
