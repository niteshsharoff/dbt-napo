    ...
    with_discount_and_ipt_amount as (
        select
            *,
            ...
            premium_price
            - {{ target.schema }}.calculate_amount_exc_ipt(premium_price) as ipt_amount
        from with_premium_and_retail_price
    ),
    apply_rounding as (
        -- pre-mature rounding to keep reporting in line with premium_bdx
        select
            * except (retail_price, premium_price, discount_amount, ipt_amount),
    ...
    with_underwriter_dimension as (
        select
            ...
            struct(
                ...
                cast(
                    premium_position - ipt_position as numeric
                ...
                cast(
                    premium_difference - ipt_difference as numeric
