with
    ...
    metrics_table as (
        select
            ...
            coalesce(round(new_revenue, 2), 0.0) as new_revenue,
            coalesce(round(recurring_revenue, 2), 0.0) as recurring_revenue,
            coalesce(round(other_revenue, 2), 0.0) as other_revenue
        from
            final pivot (
